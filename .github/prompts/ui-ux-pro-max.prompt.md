...
```bash
python3 C:\skills\ui-ux-pro-max\scripts/search.py "<product_type> <industry> <keywords>" --design-system [-p "Project Name"]
```
...
```bash
python3 C:\skills\ui-ux-pro-max\scripts/search.py "beauty spa wellness service" --design-system -p "Serenity Spa"
```
...
```bash
python3 C:\skills\ui-ux-pro-max\scripts/search.py "<query>" --design-system --persist -p "Project Name"
```
...
```bash
python3 C:\skills\ui-ux-pro-max\scripts/search.py "<query>" --design-system --persist -p "Project Name" --page "dashboard"
```
...
```bash
python3 C:\skills\ui-ux-pro-max\scripts/search.py "<query>" --design-system --variance <1-10> --motion <1-10> --density <1-10>
```
...
```bash
python3 C:\skills\ui-ux-pro-max\scripts/search.py "internal analytics dashboard" --design-system --variance 8 --motion 7 --density 8 -p "Ops Console"
```
...
```bash
python3 C:\skills\ui-ux-pro-max\scripts/search.py "<keyword>" --domain <domain> [-n <max_results>]
```
...
```bash
python3 C:\skills\ui-ux-pro-max\scripts/search.py "<keyword>" --stack <stack>
```
...
```bash
python3 C:\skills\ui-ux-pro-max\scripts/search.py "atlantafx primer enterprise theme" --stack javafx
python3 C:\skills\ui-ux-pro-max\scripts/search.py "enterprise tableview density permission" --stack javafx
```
...
```bash
python3 C:\skills\ui-ux-pro-max\scripts/search.py "AI search tool modern minimal" --design-system -p "AI Search"
```
...
python3 C:\skills\ui-ux-pro-max\scripts/search.py "minimalism dark mode" --domain style

# Get UX best practices for search interaction and loading
python3 C:\skills\ui-ux-pro-max\scripts/search.py "search loading animation" --domain ux
```

### Step 4: Stack Guidelines

```bash
python3 C:\skills\ui-ux-pro-max\scripts/search.py "list performance navigation" --stack react-native
```
...
python3 C:\skills\ui-ux-pro-max\scripts/search.py "fintech crypto" --design-system

# Markdown - best for documentation
python3 C:\skills\ui-ux-pro-max\scripts/search.py "fintech crypto" --design-system -f markdown
```
...
- 默认图标库使用 **Phosphor (`@phosphor-icons/react`)**。`C:\skills\ui-ux-pro-max\data/icons.csv` 中列出的只是常用推荐图标，不是完整集合。
- 当推荐表中找不到合适的图标时：
